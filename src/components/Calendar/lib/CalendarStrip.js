...
const localDate = _today.toDateString();
...
class DateItem extends PureComponent {
  render() {
    ...
    const localDate = new Date(item).toDateString();
    const highlightBgColor = '#0442D0';
    const normalBgColor = '#F0F3F8';
    ...
    return (
      <View style={styles.itemContainer}>
        <TouchableOpacity
          ...
          // style={{height: 83, width: 33, borderRadius: 10}}
          onPress={onItemPress}>
          <View
            style={[
              styles.itemView,
            ...
            {marked ? (
              <View
                style={[
                  styles.itemTopDot,
                  {backgroundColor: highlight ? '#FF9124' : '#FF9124'},
                ]}
              />
            ) : (
              <View
                style={[
                  styles.itemTopDotNull,
                  {backgroundColor: highlight ? null : null},
                ]}
              />
            )}
            {true && (
